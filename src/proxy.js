...
const startServer = (targetHost, destPort, targetPort, outputFile) => {
  const PORT = destPort || 8889; 
  const TARGET_HOST = targetHost || "194.247.183.66";
  const TARGET_PORT = targetPort || 8888;
  ...
  server.listen(PORT, () => {
    ...
    console.log(`Configure your client to use proxy at 127.0.0.1:${PORT}`);
    console.log(
